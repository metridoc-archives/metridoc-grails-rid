...
<md:report>
    ...
    <div class="md-application-content">
        ...
        <div id="list-ridInstructionalMaterials" class="content scaffold-list" role="main">
            <h1>
                <g:message code="default.list.label" args="[entityName]"/>
                <a data-tooltip="Creating" href="create?dummy=${org.apache.commons.lang.math.RandomUtils.nextInt()}"
                   data-target="#myModal" data-toggle="modal">
                    <i title="Create Material" class="icon-plus-sign-alt"></i>
                </a>
            </h1>
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <g:sortableColumn property="name"
                                      title="${message(code: 'ridInstructionalMaterials.name.label', default: 'Name')}"/>

                    <g:sortableColumn property="inForm"
                                      title="${message(code: 'ridInstructionalMaterials.inForm.label', default: 'In Form')}"/>
